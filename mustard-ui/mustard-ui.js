const includes = {
  ...
  "input[type='color'],input[type='date'],input[type='datetime-local'],input[type='email'],input[type='month'],input[type='number'],input[type='range'],input[type='search'],input[type='tel'],input[type='time'],input[type='url'],input[type='week'],input[type='text'],input[type='password'],select": {
    "-webkit-appearance": "none",
    "-moz-appearance": "none",
    "appearance": "none",
    "display": "block",
  ...
  "input::-webkit-input-placeholder,select::-webkit-input-placeholder,fieldset::-webkit-input-placeholder": {
    "color": "#9e9e9e"
  },
  "input:-ms-input-placeholder,select:-ms-input-placeholder,fieldset:-ms-input-placeholder": {
    "color": "#9e9e9e"
  },
  "input::-ms-input-placeholder,select::-ms-input-placeholder,fieldset::-ms-input-placeholder": {
    "color": "#9e9e9e"
  ...
  "header .disclaimer,.header .disclaimer": {
    "font-size": "12px",
    "color": "#424242",
    "text-align": "center"
  },
  "header .scroll-down,.header .scroll-down": {
    "display": "flex",
    "align-items": "center",
    "justify-content": "center",
    "position": "absolute",
  ...
  "header .scroll-down::before,.header .scroll-down::before": {
    "display": "block",
    "position": "relative",
    "bottom": "2px",
    "content": "''",
  ...
  ".sidebar-category": {
    ...
    "color": "#757575",
    "border-bottom": "1px solid #e0e0e0",
    "background": "url('data:image/svg+xml,utf8,<svg xmlns=%27http://www.w3.org/2000/svg%27 height=%2714%27 viewBox=%270 0 29 14%27 width=%2729%27><path d=%27M9.4 3.6l5.1 6.9L19.5 3.6%27 fill=%27#bdbdbd%27/></svg>') center right no-repeat"
  },
